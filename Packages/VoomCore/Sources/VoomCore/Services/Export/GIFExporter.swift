...
public actor GIFExporter {
    public static let shared = GIFExporter()
    ...
    @MainActor
    public func copyToClipboard(_ data: Data) {
    ...
    @MainActor
    public func saveToFile(_ data: Data, suggestedName: String = "recording.gif") async -> URL? {
